...
import { Users, Shield, QrCode, Award } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col items-center justify-center p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full">
                ...
                {/* Certificate Claim (Public) */}
                <Link
                    to="/certificate/claim"
                    className="group bg-slate-800/50 border border-slate-700 rounded-2xl p-8 hover:bg-slate-700/50 hover:border-indigo-500/50 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-indigo-500/10"
                >
                    <div className="flex flex-col items-center text-center">
                        <div className="p-4 bg-yellow-900/30 rounded-xl mb-4 group-hover:bg-yellow-900/50 transition-colors">
                            <Award size={40} className="text-yellow-400" />
                        </div>
                        <h2 className="text-xl font-bold text-white mb-2">Get Certificate</h2>
                        <p className="text-slate-400 text-sm">Download your participation certificate</p>
                    </div>
                </Link>
            </div>
